...
const createSlider = () => {
  ...
  let isnum = /^\d+$/.test(duration_value);
...
searchBtn.addEventListener('click', function () {
  ...
  if(slideButton.classList[1] == 'btn-success'){
    ...
    slideButton.classList.add('btn-danger');
    slideButton.innerHTML = "Pause";
  }
...
function loadData(){
  document.getElementById('data-load').classList.toggle('d-none');
}

document.getElementById('slide-btn').addEventListener('click', (event) => {
